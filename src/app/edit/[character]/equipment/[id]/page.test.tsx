...
import { createCharacter, renderWithData } from "app/edit/[character]/helpers-test";
...
vi.mock("next/navigation", () => ({
  useParams: () => ({ id: "test-id", character: 1 }),
  usePathname: () => "",
}));

describe("/edit/equipment/id", () => {
  beforeAll(async () => {
    cleanup();
    await renderWithData(<PageContent id="test-id" />);
  });
...
describe("/edit/equipment/id for weapons", () => {
  beforeEach(() => {
    cleanup();
  });
